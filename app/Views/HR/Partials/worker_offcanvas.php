...
<!-- ============================================================ -->
<div class="offcanvas offcanvas-end" style="width: min(580px, 95vw);" tabindex="-1" id="offcanvasWorker" aria-labelledby="offcanvasWorkerLabel">
            ...
            <div class="tab-content px-4 py-3" id="workerOffcanvasTabContent">
                ...
                <div class="tab-pane fade show active" id="oc-tab-personal" role="tabpanel">
                    <table class="table table-sm table-borderless">
                        <tbody>
                            <tr>
                                <td class="text-muted ps-0" style="width:38%"><i class="fas fa-id-card fa-fw me-1"></i>CURP</td>
                            ...
                            <tr>
                                <td class="text-muted ps-0"><i class="fas fa-birthday-cake fa-fw me-1"></i>Fecha Nac.</td>
                            ...
                            <tr>
                                <td class="text-muted ps-0"><i class="fas fa-envelope fa-fw me-1"></i>Email Personal</td>
                ...
                <div class="tab-pane fade" id="oc-tab-laboral" role="tabpanel">
                    <table class="table table-sm table-borderless">
                        <tbody>
                            <tr>
                                <td class="text-muted ps-0" style="width:38%"><i class="fas fa-calendar-plus fa-fw me-1"></i>Fecha Ingreso</td>
                            ...
                            <tr>
                                <td class="text-muted ps-0"><i class="fas fa-envelope-open fa-fw me-1"></i>Email Corp.</td>
                                <td id="oc-w-corporate-email" class="small"></td>
                            </tr>
                            <tr>
                                <td class="text-muted ps-0"><i class="fas fa-dollar-sign fa-fw me-1"></i>Salario Mensual</td>
                                <td id="oc-w-salary" class="fw-semibold text-success"></td>
                            </tr>
                            <tr>
                                <td class="text-muted ps-0"><i class="fas fa-calendar-day fa-fw me-1"></i>Salario Diario</td>
                ...
                <div class="tab-pane fade" id="oc-tab-contratos" role="tabpanel">
                    ...
                    <div class="d-flex gap-2 mb-3 flex-wrap">
                        ...
                        <button class="btn btn-sm btn-outline-primary" id="oc-btn-new-contract" disabled>
                    ...
                    <!-- Árbol cronológico de contratos (placeholder) -->
                    <div id="oc-contracts-timeline">
                        <div class="text-center py-4 text-muted">
                            <i class="fas fa-file-contract fa-2x mb-2 d-block"></i>
                            <span class="small">No hay contratos registrados aún.<br>
                            El módulo de contratos se habilitará próximamente.</span>
                        </div>
                    </div>
...
function loadWorkerOffcanvas(profileId) {
    ...
    .then(resp => {
        ...
        // Fijar href del enlace de edición (se inserta vía innerHTML, href se evalúa después)
