...
class WorkerController extends BaseController
{
    ...
    public function new_worker(): string
    {
    ...
    public function update(int $profileId)
    {
        ...
        $logModel = new \App\Models\Users\UserActivityLogsModel();
        $logModel->logActivity('update_worker', 'Actualizó datos del trabajador (profile_id: ' . $profileId . ')');

        $this->setOutputSuccess('Trabajador actualizado correctamente.');
        $this->outputData['response'] = ['profile_id' => $profileId];
    ...
    // La función privada _getAvailableUsers() fue removida de este controlador. 
    // Ahora dicha consulta reside en HrProfileModel->getAvailableUsers() para cumplir con el estándar MVC.
}
